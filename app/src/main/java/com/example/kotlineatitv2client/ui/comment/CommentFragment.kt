...
class CommentFragment : BottomSheetDialogFragment (), ICommentCallBack {
    ...
    private fun initViews(itemView: View?) {
        ...
        val layouManager = LinearLayoutManager(context, RecyclerView.VERTICAL, true)
        recycler_comment!!.layoutManager = layouManager
        recycler_comment!!.addItemDecoration(DividerItemDecoration(context!!, layouManager.orientation))
    }
